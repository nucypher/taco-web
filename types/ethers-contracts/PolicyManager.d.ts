...
export class PolicyManager extends BaseContract {
  ...
  functions: {
    ...
    nodes(
      arg0: string,
      overrides?: CallOverrides,
    ): Promise<[ BigNumber, number, BigNumber, BigNumber ] & {
      fee: BigNumber;
  ...
  filters: {
    ArrangementRevoked(
      ...
      node?: string | null,
      value?: null,
    ): TypedEventFilter<[ string, string, string, BigNumber ],
    ...
    FeeRateRangeSet(
      ...
      defaultValue?: null,
      max?: null,
    ): TypedEventFilter<[ string, BigNumber, BigNumber, BigNumber ],
      {
        sender: string;
        min: BigNumber;
        defaultValue: BigNumber;
    ...
    PolicyCreated(
      ...
      endTimestamp?: null,
      numberOfNodes?: null,
    ): TypedEventFilter<[ string, string, string, BigNumber, BigNumber, BigNumber, BigNumber ],
      {
        policyId: string;
        sponsor: string;
        owner: string;
