...
import { nonFloatReturnValueTestSchema } from './return-value-test';
...
export const rpcConditionSchema = baseConditionSchema
  .extend({
    ...
    returnValueTest: nonFloatReturnValueTestSchema, // Update to allow multiple return values after expanding supported methods
  })
  .describe(
