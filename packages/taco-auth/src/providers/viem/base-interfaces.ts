...
/**
 * Minimal Provider interface needed by TACo auth providers
 *
 * This defines the minimal contract that both ethers providers and viem-wrapped providers
 * must satisfy for TACo authentication providers to work correctly.
 *
 ...
 */
export interface TacoAuthProvider {
  /**
...
/**
 * Minimal Signer interface needed by TACo auth providers
 *
